...
const updateOrderService = async (req: NextApiRequest, res: NextApiResponse) => {
    ...
    const endpoint:string = `${restConfiguration.apiCmsHost}/api/v1/order/${req.body.orderReference}`;
